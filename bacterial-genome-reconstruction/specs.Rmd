...
blastdbcmd -db db/blast_db/all_seqs_db -entry $acc -outfmt "%f" > \
    data/"$acc".txt
```

### Module 2: Read length optimization
...
for CUTOFF in 230 240 250
    do
	makeblastdb \
        -in output/module_2/cutoff_$CUTOFF.txt \
